...
// ============================= //
type ViewportId = 'CT_AXIAL' | 'CT_SAGITTAL' | 'CT_CORONAL';
...
function getReferenceLineColor(viewportId: ViewportId) {
  return viewportColors[viewportId];
}

function getReferenceLineControllable(viewportId: ViewportId) {
  const index = viewportReferenceLineControllable.indexOf(viewportId);
  return index !== -1;
}

function getReferenceLineDraggableRotatable(viewportId: ViewportId) {
  const index = viewportReferenceLineDraggableRotatable.indexOf(viewportId);
  return index !== -1;
}

function getReferenceLineSlabThicknessControlsOn(viewportId: ViewportId) {
  const index =
